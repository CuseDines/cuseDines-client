<template>
    ...
    <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-primary border-r z-30" :class="sideBarOpen ? '' : 'hidden'" id="main-nav">

          <div class="w-full h-20 bg-primary border-b flex items-center mb-8">
            <img class="h-20 w-full" src="@/assets/img/cuseDines.jpeg" alt="">
          </div>

          <div class="mb-4 px-4">
            <p class="pl-4 text-sm font-semibold mb-1">MAIN</p>
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 bg-gray-200 hover:bg-gray-200 rounded-lg cursor-pointer" @click="redirectTo('/home')">
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer" @click="redirectTo('/orders')">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer" @click="redirectTo('/cart')">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            ...
            <!-- <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              ...
              <span class="text-secondary">Mealpass</span>
            </div> -->
            <!-- <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
              ...
              <span class="text-secondary">Calender</span>
            </div> -->
          </div>

          <div class="mb-4 px-4">
            <p class="pl-4 text-sm font-semibold mb-1">Account</p>
            <!-- <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            ...
            <div class="w-full flex items-center text-secondary h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer" @click="redirectTo('/account')">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            ...
            <div 
              class="w-full flex items-center text-secondary 
                h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
              @click="logout()"  
            >
              <svg class="fill-current h-6 w-6 mr-2" viewBox="0 0 320 320">
                <path d="M51.2 175H225a15 15 0 000-30H51.2l19.4-19.4a15 15 0 10-21.2-21.2l-45 45-1 1.1-.4.5-.5.7-.4.6-.3.6-.4.7-.3.7-.2.6c0 .3-.2.5-.3.7l-.1.7-.2.8-.1.8-.1.6L0 160v1.5l.2.6v.8l.3.8.1.7.3.7.2.6.3.7.4.7.3.6.4.6.5.7.4.5 1 1v.1l45 45a15 15 0 0021.2 0 15 15 0 000-21.2L51.2 175z"/>
                <path d="M305 25H115a15 15 0 00-15 15v60a15 15 0 0030 0V55h160v210H130v-45a15 15 0 00-30 0v60a15 15 0 0015 15h190a15 15 0 0015-15V40a15 15 0 00-15-15z"/>
              </svg>
