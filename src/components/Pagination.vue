		...
		<ul class="pagination p-2 shadow-sm rounded">
			<li class="pagination-item">
				...
				<a
					...
					class="rounded-l rounded-sm border-t border-r border-b border-l border-gray-100 px-3 py-2 text-gray-600 hover:bg-gray-100 no-underline"
					href="#"
					role="button"
					rel="prev"
				>
			...
			>
				<span
					class="rounded-sm border border-blue-100 px-3 py-2 bg-blue-100 no-underline text-blue-500 cursor-not-allowed mx-2 text-secondary"
...
.active {
  @apply .border-t .border-b .border-l .border-secondary .px-3 
  .py-2 .bg-secondary .no-underline .text-secondary .text-sm;
}
